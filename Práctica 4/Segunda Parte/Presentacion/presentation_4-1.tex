...
\begin{frame}
	...
	\begin{itemize}
		\item \textbf{Solución parcial}: para poder calcular la solución, mantendremos un vector con las distancias mínimas.
		Despues, para cada nodo, calcularemos una cota local
		x
	\end{itemize}
